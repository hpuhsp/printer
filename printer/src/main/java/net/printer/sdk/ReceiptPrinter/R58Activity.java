...
import net.printer.sdk.utils.DataForSendToPrinterPos58;
...
public class R58Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void printBitmap() {
        final Bitmap bitmap1 = BitmapProcess.compressBmpByYourWidth(BitmapFactory.decodeResource(getResources(), R.drawable.test), 300);
